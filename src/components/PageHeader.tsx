      ...
      <div className="intro-div">
        <div className="basis-2/3 mx-8 mt-10 tablet:mt-0">
          ...
          <p className="intro-description">
            ...
            solutions across multiple domains. My expertise spans engineering, frontend
            development and payment systems implementation, where I excel in
            delivering seamless integrations and user-focused designs. With a
            proven ability to collaborate with cross-functional teams and adapt
            to dynamic challenges, I am committed to driving technical
            excellence and achieving impactful results.{" "}
          </p>
